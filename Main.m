%main.m
clf
cueball = Ball(120, 50, 2, 0, 'k.');
ball1 = Ball(140, 50, 0, 0, 'r.');
%      r2 = -0.1+(0.1+0.1).*rand(1,1)
ball2 = Ball(146, 53, 0, 0, 'b.');
%      r3 = -0.1+(0.1+0.1).*rand(1,1)
ball3 = Ball(146, 47, 0, 0, 'g.');
...
hold on
array = [cueball ball1 ball2 ball3];% ball4]% ball5 ball6 ball7 ball8 ball9 ball10 ball11 ball12];
